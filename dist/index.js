...
import { createData, sign, addTag } from './ar-data-create';
...
export { createData as create, sign, decodeData, decodeTag, decodeTagAt, unpackTags, verify, DataItemJson, getSignatureData };
export default function ArweaveData(deps) {
    return {
